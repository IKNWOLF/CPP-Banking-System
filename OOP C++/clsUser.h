...
private:
    ...
    string _PrepareLoginRecord(string seperator = "#//#") {
        ...
        LoginRecord += clsDate::GetSystemDateInString() + seperator;
...
public:
    ...
    enum enPermissions {
        ...
        , eUpdateClient = 8, eFindClient = 16, eTransactions = 32, eManageUsers = 64, eLoginsRegister = 128
    };
    ...
    static vector <stLoginRegisterRecord> GetLoginsRegisterList()
    {
