...
#include "clsShowManageUsersMenu.h"
#include "Global.h";
#include "clsLoginScreen.h"
#include "clsLoginsRegister.h"
...
private:
    enum enMainMenuOptions {
        ...
        eManageUsers = 7, eLoginsRegister = 8, eCurrencyExchange , eExit = 10
    };
    ...
    static void _ShowLoginsRegister() {
        clsLoginsRegister::ShowLoginRegisterScreen();
    }
